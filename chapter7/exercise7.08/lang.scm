(module lang (lib "eopl.ss" "eopl") 
  ...
  (define the-grammar
    '((program (expression) a-program)
      ...
      (expression
        ("letrec"
          type identifier "(" (separated-list identifier ":" type  ",") ")" "=" expression
           "in" expression)
        letrec-exp)
...
;            (type-to-external-form result-type))))))
        (proc-type (arg-types result-type)
          (append
           (map (lambda (arg-type) (type-to-external-form arg-type)) arg-types)
           (list '->
                 (type-to-external-form result-type))))
        (pair-type (first-type rest-type)
          (list
           (type-to-external-form first-type)
           (type-to-external-form rest-type))))))

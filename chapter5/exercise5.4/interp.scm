...
;;;;;;;;;;;;;;;; the interpreter ;;;;;;;;;;;;;;;;
    ...
    (lambda (exp env cont)
      (cases expression exp
        ...
        (let3-exp (var1 exp1 var2 exp2 var3 exp3 body)
          (value-of/k exp1 env
                      (let3-exp1-cont var1 var2 exp2 var3 exp3 body env cont)))
   )))
  ...
  ; let3-exp1-cont : var * var * Exp * var * Exp * Env * Cont -> Cont
  (define let3-exp1-cont
    (lambda (var1 var2 exp2 var3 exp3 body env cont)
      (lambda (val)
        (value-of/k exp2 env
          (let3-exp2-cont var2 var3 exp3 body (extend-env var1 val env) cont)))))

  ; let3-exp2-cont : var * var * Exp * Exp * Env * Cont -> Cont 
  (define let3-exp2-cont
    (lambda (var2 var3 exp3 body env cont)
      (lambda (val)
        (value-of/k exp3 env
          (let3-exp3-cont var3 body (extend-env var2 val env) cont)))))

  ; let3-exp3-cont : var * Exp * Env * Cont -> Cont
  ; Cont is not change
  (define let3-exp3-cont
    (lambda (var3 body env cont)
      (lambda (val)
